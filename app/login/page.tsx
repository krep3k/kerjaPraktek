...
export default function LoginPage(){
    ...
    return (
        <div className="min-h-screen flex bg-[#81CAD6] font-sans">
            <div className="hidden lg:flex lg:w-3/5 bg-[#DC3E26] relative overflow-hidden items-center justify-center p-12">
                ...
                <div className="relative z-10 max-w-lg text-white">
                    <div className="inline-flex items-center gap-3 bg-white/10 backdrop-blur-md p-4 rounded-2xl border border-white/20 mb-12 shadow-2xl">
                        <School className="w-10 h-10 text-[#EDCD44]"/>
                        <span className="text-2xl font-[900] tracking-tighter">SIAKAD DIGITAL</span>
                    </div>
                    <h1 className="text-6xl font-[900] leading-tight mb-6">
                        Kelola Absensi <br />
                        <span className="text-[#EDCD44]">Lebih Efisien</span>
                    </h1>
                    <p className="text-xl text-white/80 font-medium leading-relaxed opacity-90">
            ...
            <div className="w-full lg:w-2/5 flex items-center justify-center p-6 sm:p-12">
                <div className="w-full max-w-md">
                    <div className="bg-white p-10 sm:p-12 rounded-[2.5rem] shadow-2xl shadow-[#DC3E26]/20 border border-[#F4E1A4]">
                        <div className="mb-10">
                        ...
                        <form action="" onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <button type="submit" disabled={loading} className="w-full flex items-center justify-center gap-3 bg-[#EDCD44] text-[#2D2735] py-4 rounded-2xl font-black text-sm hover:bg-[#D6C43D] hover:shadow-xl hover:shadow-[#EDCD44]/20 active:scale-[0.98] transition-all disabled:opacity-70 mt-4 uppercase tracking-widest">
                            ...
                            <Link href="/" className="w-full flex items-center justify-center gap-2 mt-3 py-4 rounded-2xl border-2 border-[#F4E1A4] text-[#2D2735] font-black text-sm hover:bg-[#F9F2CE] hover:border-[#EDCD44] transition-all uppercase tracking-widest">
